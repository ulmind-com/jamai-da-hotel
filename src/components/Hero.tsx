...
const Hero = () => {
  ...
  return (
    <section className="relative h-[400px] sm:h-[500px] md:h-[600px] overflow-hidden bg-[hsl(var(--hero-bg))]">
      <div 
        className="absolute inset-0 bg-cover bg-center mix-blend-multiply opacity-70"
        style={{ backgroundImage: `url(${heroImage})` }}
      >
        <div className="absolute inset-0 bg-gradient-to-r from-secondary/30 via-transparent to-accent/20" />
      </div>
