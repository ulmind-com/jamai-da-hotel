  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="w-full h-full max-w-full p-0 translate-x-0 translate-y-0 top-0 left-0 right-0 bottom-0 md:left-[50%] md:top-[50%] md:translate-x-[-50%] md:translate-y-[-50%] md:max-w-2xl md:max-h-[80vh] md:h-auto md:w-auto md:rounded-lg">
          ...
          <ScrollArea className="flex-1 h-[calc(100vh-180px)] md:h-[400px] px-6 pb-6">
            {searchQuery.trim() === "" ? (
